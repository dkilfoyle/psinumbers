module.exports = {
  ...
  pPASTAPos: { name: 'pPASTAPos', val: 0.65, default: 0.65, group: 'Clinical', label: 'PASTA Positive', helper: '% of hyperacute stroke that pass the PASTA screen' },
  pMimics: { name: 'pMimics', val: 0.37, default: 0.37, group: 'Clinical', label: 'After hours', helper: '% of hyperacute stroke presenting after hours' }
}
